...
export default function (props: DeleteProps) {
    return(
        <>
        {props.deleteIsOpen && (
        <>
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
                <div className="relative px-4 min-h-screen md:flex md:items-center md:justify-center">
                    ...
                    <div className="md:flex items-center">
                        ...
                        <p className="font-bold">Delete all Products</p>
                        <p className="text-sm text-gray-700 dark:text-white mt-1">You will lose all of your data by deleting all products. This action cannot be undone.
                        </p>
                        </div>
                    </div>
                    <div className="text-center md:text-right mt-4 md:flex md:justify-end">
                        <button
                            onClick={props.removeAllProducts}
