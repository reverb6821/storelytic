                  ...
                  <li className="text-gray-700 pt-8">
                    <div className="flex items-center">
                      <div className="flex items-center">
                        ...
                        <p className="text-gray-700 ml-3 text-lg">Delivery</p>
                      </div>
                      <div onClick={() => setDelivery(!delivery)}>
                        {delivery ? (
                          <div className=" ml-4">
                    ...
                    {delivery ? (
                      <div>
                        <ul className="my-3">
                          <li className="text-sm text-indigo-500 py-2 px-6">Expecting</li>
                          <li className="text-sm text-gray-800 hover:text-indigo-500 py-2 px-6">Consignee</li>
                          <li className="text-sm text-gray-800 hover:text-indigo-500 py-2 px-6">Test</li>
                  ...
                  <li className="text-gray-800 pt-8">
                    <div className="flex items-center">
                      <div className="flex items-center">
                        ...
                        <p className="text-gray-800 ml-3 text-lg">Stock</p>
                      </div>
                    ...
                    {stock ? (
                      <div>
                        <ul className="my-3">
                          ...
                          <li className="text-sm text-gray-800 hover:text-indigo-500 py-2 px-6">Stock Transfer</li>
                        </ul>
                      </div>
                    ) : (
                      ""
          ...
          <div className="flex items-center">
            ...
            <ul className="pr-32 xl:flex hidden items-center h-full">
              ...
              <li className="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-gry-800 mx-10 tracking-normal relative">
                {delivery ? (
                  <ul className="bg-white shadow rounded py-1 w-32 left-0 mt-16 -ml-4 absolute  top-0">
                    <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 px-3 font-normal">Expecting</li>
                    <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 px-3 font-normal">Consignee</li>
                    <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 px-3 font-normal">Test</li>
                  </ul>
                ) : (
                  ""
                )}
                Delivery
                <span className="ml-2" onClick={() => setDelivery(!delivery)}>
              ...
              <li className="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-gray-800 tracking-normal relative">
                {stock ? (
                  <ul className="bg-white shadow rounded py-1 w-32 left-0 mt-16 -ml-4 absolute  top-0">
                    <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 px-3 font-normal">Out of Stock</li>
                    <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 px-3 font-normal">Stock Transfer</li>
                  </ul>
                ) : (
                  ""
                )}
                Stock
                <span className="ml-2" onClick={() => setStock(!stock)}>
                  <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-down" width={16} height={16} viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" />
                    <polyline points="6 9 12 15 18 9" />
                  </svg>
            ...
            <div className="h-full flex items-center">
              ...
              <div className="w-full h-full flex">
                ...
                <div aria-haspopup="true" className="cursor-pointer w-full flex items-center justify-end relative" onClick={() => setProfile(!profile)}>
                   {profile ? (
                    <ul className="p-2 w-40 border-r bg-white absolute rounded z-40 left-0 shadow mt-60 ">
                  ...
                  <p className="text-gray-800 text-sm ml-2"> {currentUser.username}</p>
                </div>
                ) : (
                ""
                  )}
